...
class FormalRunner:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.rgg_source = self.repo_root / "v15/src/rggpbft"
        ...
        self.provenance = {
            ...
            "source": source_manifest(
                self.repo_root,
                [
                    self.repo_root / "v15/src/fabric_chaincode",
                    self.repo_root / "v15/src/rggpbft",
    ...
    def aggregate(self) -> None:
        ...
        for entry in self.entries:
            ...
            total = [
                ...
                + rgg_summary["client_latency_ms"]["mean"]
                for row in stage_a
            ]
            aggregate_entries.append(
                {
                    **entry,
                    ...
                    "sequential_component_total": summarize_latencies(
                        total
                    ),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        / "v15/results/multijudge-v15/mj5/workload",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=default_repo
        / "v15/results/multijudge-v15/mj5/formal",
    )
